...
Include the theme script and define CSS variables for dark/light modes:
...
| `--dot-bg`      | `#333`                   | `#ccc`             |
| `--text-color`  | `rgba(255,255,255,0.3)`  | `rgba(0,0,0,0.4)`  |
...
3. **Theme sync**: `demo-theme.js` passes blog theme state to iframe via `postMessage`
