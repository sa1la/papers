...
- **preserve**：保持 JSX 语法不变，`.tsx` 文件输出为 `.jsx`。
...
它可以取以下值：none、commonjs、amd、umd、system、es6/es2015、es2020、es2022、esnext、node16、nodenext、preserve。`preserve` 需要 TypeScript 5.4+
